...
# 座位(list) 多个座位ex:"商务座","一等座","二等座","特等座","软卧","硬卧","硬座","无座",
# "商务座",
# "一等座",
# "二等座",
# "特等座",
...
EMAIL_CONF = {
    "IS_MAIL": True,
    "email": "954956379@qq.com",
    "notice_email_list": "954956379@qq.com",
    "username": "954956379",
    "password": "knbuhlhoxwwfbbfa",
    "host": "smtp.qq.com",
}
...
import os
CHROME_PATH = os.path.dirname(__file__)+"/chromedriver"
